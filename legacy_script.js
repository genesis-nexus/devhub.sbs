...
function createQRGeneratorInterface() {
    return `
        <div class="tool-interface">
            ...
            <div class="output-group" id="qr-output" style="display: none; text-align: center; padding: 1.5rem; background: white; border-radius: 8px; margin-top: 1rem;">
...
function initializeQRGeneratorTool() {
    ...
    generateBtn.addEventListener('click', () => {
        ...
        if (typeof QRCode === 'undefined') {
            showNotification('QRCode library not loaded. Please refresh the page.', 'error');
            return;
        }
    ...
    downloadBtn.addEventListener('click', () => {
        if (output.style.display === 'none' || !container.querySelector('canvas')) {
